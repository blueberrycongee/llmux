...
// Responses handles POST /v1/responses requests for the legacy handler.
func (h *Handler) Responses(w http.ResponseWriter, r *http.Request) {
	h.writeError(w, llmerrors.NewInvalidRequestError("", "", "responses endpoint is not available on legacy handler"))
}
