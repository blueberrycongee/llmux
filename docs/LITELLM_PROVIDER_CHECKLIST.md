# LiteLLM Provider Checklist

Source: `D:\Desktop\litellm-main\litellm\llms\*` (local snapshot). Generated at (UTC): 2026-01-13T08:00:29Z
Last aligned at (Local): 2026-01-13 16:43:37

Use the checkboxes to mark alignment completion:
- `[x]` aligned (native adapter or OpenAI-compatible fallback)
- `[~]` deferred / not applicable (see Notes)

## Provider Modules
| Provider | Aligned | Completed At (Local) | Notes |
| --- | --- | --- | --- |
| ai21 | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| aiml | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| aiohttp_openai | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| amazon_nova | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
...
| clarifai | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| cloudflare | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| codestral | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| cohere | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| cometapi | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| compactifai | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
...
| gradient_ai | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| groq | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| heroku | [~] | 2026-01-13 16:43:37 | deployment integration (deferred) |
...
| lemonade | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| linkup | [~] | 2026-01-13 16:43:37 | search tool (deferred) |
| llamafile | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| lm_studio | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| manus | [~] | 2026-01-13 16:43:37 | missing in local LiteLLM snapshot (deferred) |
| meta_llama | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| milvus | [~] | 2026-01-13 16:43:37 | vector store integration (deferred) |
...
| ovhcloud | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| parallel_ai | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
...
| vllm | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| volcengine | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
| voyage | [x] | 2026-01-13 16:43:37 | aligned via native adapter or OpenAI-compatible fallback |
...
| Module | Notes |
| --- | --- |
| base_llm | shared infrastructure |
| custom_httpx | shared infrastructure |
| deprecated_providers | shared infrastructure |
| pass_through | shared infrastructure |
| litellm_proxy | shared infrastructure |
