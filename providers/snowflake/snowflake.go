// Package snowflake provides the Snowflake Cortex provider for LLMux library mode.
package snowflake
...
const (
	...
	DefaultBaseURL = "" // Requires account URL
)
...
var providerInfo = openailike.Info{
	...
	ModelPrefixes:     []string{"snowflake-arctic", "llama", "mistral"},
}
